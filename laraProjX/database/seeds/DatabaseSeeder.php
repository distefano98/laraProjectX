...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('category')->insert([
            ...
            ['nome' => 'Android', 'parId' => 3, 'desc' => 'Prodotti con sistema operativo: Android'],
        ]);
        ...
        DB::table('users')->insert([
            ['nome' => 'Mario', 'cognome' => 'Rossi', 'email' => null, 
                'residenza' => null , 'nascita' => null, 'occupazione' => null ,
                'username' => 'adminadmin', 'password' => Hash::make('KOqqNFKo'), 
                'ruolo' => 'admin','created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
            ['nome' => 'Giuseppe', 'cognome' => 'Verdi', 'email' => null, 
                'residenza' => null , 'nascita' => null, 'occupazione' => null,
            ...
            ['nome' => 'Giovanni', 'cognome' => 'Badiali', 'email' => 'giovanni@badiali.it', 
                'residenza' => 'Pesaro', 'nascita' => null, 'occupazione' => 'ingegnere ',
            ...
            ['nome' => 'Samuele', 'cognome' => 'Gasparroni', 'email' => 'samuele@gasparroni.it', 
                'residenza' => 'Urbino', 'nascita' => null, 'occupazione' => 'operaio',
                'username' => 'SamueleGasparroni65', 'password' => Hash::make('SamueleGasparroni65'), 
                'ruolo' => 'user','created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
            ['nome' => 'Paolo', 'cognome' => 'Bianchi', 'email' => null, 
                'residenza' => null, 'nascita' => null, 'occupazione' => null,
                'username' => 'staffstaff', 'password' => Hash::make('KOqqNFKo'), 
                'ruolo' => 'staff','created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
            ['nome' => 'Giacomo', 'cognome' => 'Neri', 'email' => 'giacomo@neri.it', 
                'residenza' => '', 'nascita' => null, 'occupazione' => '',
                'username' => 'useruser', 'password' => Hash::make('KOqqNFKo'), 
                'ruolo' => 'user','created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
            ['nome' => 'Maria', 'cognome' => 'Esposito', 'email' => 'maria@esposito.it', 
                'residenza' => 'Napoli', 'nascita' => null, 'occupazione' => 'architetto',
                'username' => 'MariaEsposito86', 'password' => Hash::make('MariaEsposito86'), 
                'ruolo' => 'user','created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
            ['nome' => 'Vincenzo', 'cognome' => 'Vasari', 'email' => 'vincenzo@vasari.it', 
                'residenza' => 'Roma', 'nascita' => null, 'occupazione' => 'professore',
                'username' => 'VincenzoVasari63', 'password' => Hash::make('VincenzoVasari63'), 
                'ruolo' => 'user','created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
            ['nome' => 'Alberto', 'cognome' => 'Papa', 'email' => 'alberto@pope.it', 
                'residenza' => null, 'nascita' => null, 'occupazione' => null,
                'username' => 'AlbertoPapa', 'password' => Hash::make('AlbertoPapa99'), 
                'ruolo' => 'staff','created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
            ['nome' => 'Fabrizio', 'cognome' => 'De Angelis', 'email' => 'fabri@dea.it', 
                'residenza' => 'Palermo', 'nascita' => null, 'occupazione' => '',
                'username' => 'FabrizioDeAngelis', 'password' => Hash::make('FabrizioDeAngelis77'), 
                'ruolo' => 'user','created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
        ]);
    }
}
